...
void connection_handler(int* socket_emisor){
	...
	switch (tipo_mensaje) {
		...
		case HANDSHAKE_INICIAL:{
			...
			log_trace(logger, "[Nueva Conexion] Se conecto un proceso %s con ID %s.", get_nombre_proceso(handshake_recibido->tipoProceso), handshake_recibido->id);
		...
		case GUARDAR_PEDIDO:{
			...
			log_trace(logger, "[Recepcion Mensaje] Se recibio GUARDAR_PEDIDO: Restaurante: %s, ID_Pedido: %d.", msg_guardar_pedido->restaurante, msg_guardar_pedido->id_pedido);
		...
		case GUARDAR_PLATO:{
			...
			log_trace(logger, "[Recepcion Mensaje] Se recibio GUARDAR_PLATO: Restaurante: %s, ID_Pedido: %d, Plato: %s, Cant: %d.", recibido->restaurante, recibido->id_pedido, recibido->plato, recibido->cantPlato);
		...
		case OBTENER_PEDIDO:{
			...
			log_trace(logger, "[Recepcion Mensaje] Se recibio OBTENER_PEDIDO: Restaurante: %s, ID_Pedido: %d.", recibido->restaurante, recibido->id_pedido);
		...
		case CONFIRMAR_PEDIDO:{
			...
			log_trace(logger, "[Recepcion Mensaje] Se recibio CONFIRMAR_PEDIDO: Restaurante: %s, ID_Pedido: %d.", recibido->restaurante, recibido->id_pedido);
		...
		case PLATO_LISTO:{
			...
			log_trace(logger, "[Recepcion Mensaje] Se recibio PLATO_LISTO: Restaurante: %s, ID_Pedido: %d, Plato: %s.", recibido->restaurante, recibido->id_pedido, recibido->plato);
		...
		case FINALIZAR_PEDIDO:{
			...
			log_trace(logger, "[Recepcion Mensaje] Se recibio FINALIZAR_PEDIDO: Restaurante: %s, ID_Pedido: %d.", recibido->restaurante, recibido->id_pedido);
		...
		default:
			log_error(logger, "[ERROR] Se recibe un mensaje no admitido por COMANDA.");
			break;
	}
	close(*socket_emisor);
	free(socket_emisor);
